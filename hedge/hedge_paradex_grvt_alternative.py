...
class DNHedgeBot:
    def __init__(
        ...
        self.log_filename = f"logs/dn_alternative_{self.primary_exchange}_{self.hedge_exchange}_{ticker}_log.txt"
        self.csv_filename = f"logs/dn_alternative_{self.primary_exchange}_{self.hedge_exchange}_{ticker}_trades.csv"
